// definitions
const COMMENTS = ["うぽつ", "8888", "おつ", "ここすき", "ええやん", "ｱｶﾈﾁｬﾝｶﾜｲｲﾔｯﾀｰ", "おいしそう"];
const COMMENT_CONTAINER_ID = "_DNDC_Container";
const COMMENT_BUTTON_CLASS_NAME = "_DNDC_Button";
const _$ = (s) => document.querySelector(s);
const _$$ = (s) => document.querySelectorAll(s);
const _byId = (s) => document.getElementById(s);
...
buttonsContainerEl.id = COMMENT_CONTAINER_ID;
...
COMMENTS.forEach((comment) => {
  ...
  buttonEl.classList.add(
    ...[
      COMMENT_BUTTON_CLASS_NAME,"Pressable",
      "cursor_pointer",
      "d_inline-flex",
      "ai_center",
      "jc_center",
...
// mutation observer to append buttons container
const callbackFn = (_mutationList, _observer) => {
  const container = _byId(COMMENT_CONTAINER_ID);
  ...
  if (container == null && document.fullscreenElement == null) {
    ...
    parentEl.appendChild(buttonsContainerEl);
  }
